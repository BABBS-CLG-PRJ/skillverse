          ...
          <div className="flex flex-col gap-6 rounded-xl bg-primary-yellow p-4 lg:p-6 border-2 border-[#652429]">
            <div className="flex flex-col gap-[2px] p-3 text-sm text-black">
              ...
              <p className="font-medium">
                Our amiable staff is available to assist.
              </p>
            ...
            <div className="flex flex-col gap-[2px] p-3 text-sm text-black">
              ...
              <p className="font-medium">
                Please stop by our headquarters to say hi.
              </p>
              <p className="font-semibold">
                18/B/1 Barabagan Lane,MallickPara,Serampore,Hooghly
              </p>
            </div>
            <div className="flex flex-col gap-[2px] p-3 text-sm text-black">
              <div className="flex flex-row items-center gap-3">
              ...
              <p className="font-semibold">+91 6291196542</p>
                ...
                <Lottie animationData={Contact} className="mt-0"/>
