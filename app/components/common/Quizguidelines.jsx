  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <div className="border-b border-gray-200 pb-4 mb-6">
        <h2 className="text-xl font-medium text-gray-700">Assessment Guidelines</h2>
      ...
      <div className="space-y-6">
        <section>
          <h3 className="font-medium text-gray-800 mb-3">Timelines & Questions:</h3>
          <ul className="space-y-2 text-gray-600 list-disc list-inside">
            <li>Total Questions to be answered: 20 Questions</li>
        ...
        <section>
          <h3 className="font-medium text-gray-800 mb-3">Marking:</h3>
        ...
        <section>
          <h3 className="font-medium text-gray-800 mb-3">Key Instructions:</h3>
          <ul className="space-y-2 text-gray-600 list-disc list-inside">
        ...
        <p className="text-gray-700 font-medium">All the best!</p>
