        ...
        <div className="relative inline-block text-center w-full md:w-125">
          ...
          >
            ...
            >
              <a
                href="#option1"
                className="justify-center px-4 py-2 text-lg transition-all duration-500 font-bold text-gray-700 hover:bg-yellow-100 dark:text-black dark:hover:bg-yellow-200 dark:bg-yellow-100  flex items-center"
              >
                <svg
              ...
              <a
                href="#option2"
                className=" px-4 py-2 justify-center text-lg transition-all duration-500 font-bold text-gray-700 hover:bg-yellow-100 dark:text-black dark:hover:bg-yellow-200 dark:bg-yellow-100  flex items-center"
              >
              <Image src={gear} alt="gear icon" width={30} height={30} className="mr-2" />
              <p>
              Create manually
              </p>
